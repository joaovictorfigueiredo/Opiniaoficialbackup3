...
import PaginaDaPool from './components/PaginaDaPool';
  ...
  <div className="money-rain-container">
    ...
    <div className="coin"></div>
      ...
      <div className="max-w-md w-full bg-[#1e293b] p-8 rounded-3xl border border-gray-800 shadow-2xl">
        ...
        <h3 className="text-1xl font-black mb-8 text-center text-[#f6821f]">Uma plataforma onde sua opinião pode virar dinheiro.</h3>
...
{(() => {
  ...
  className="w-full bg-green-600 text-white text-lg font-bold p-4 rounded-xl"
>
  Depositar
</button>
...
{isModalTransacaoOpen === 'saque' && (
  <div className="mb-4 space-y-4 text-left">
    ...
    <div>
      ...
      {/* BOTÃO DE WHATSAPP COM VALIDAÇÃO DE MÍNIMO */}
{isModalTransacaoOpen === 'saque' && (
  <div className="mt-6 pt-6 border-t border-gray-800 text-center">
    ...
    <button 
      onClick={() => {
        ...
        // Se for maior que 30, abre o WhatsApp
      ...
      className={`flex items-center justify-center gap-2 w-full p-4 rounded-2xl font-black text-white text-sm transition-all ${
        Number(valorTransacao) >= 30 
          ? 'bg-[#25D366] hover:bg-[#1eb956]' 
    ...
    {/* AVISO VISUAL ABAIXO DO BOTÃO SE FOR MENOR QUE 30 */}
    {Number(valorTransacao) > 0 && Number(valorTransacao) < 30 && (
      <p className="text-orange-500 text-[9px] font-bold uppercase mt-2">
        Mínimo de R$ 30,00 necessário
      </p>
    )}
  </div>
)}
